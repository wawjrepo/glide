...
private class FlowTarget<ResourceT : Any>(
    ...
    @Volatile
    private var lastResource: Resource<ResourceT>? = null
...
@InternalGlideApi
public sealed class ResolvableGlideSize

@InternalGlideApi
public data class ImmediateGlideSize(val size: Size) : ResolvableGlideSize()
...
@InternalGlideApi
public fun Int.isValidGlideDimension(): Boolean = Util.isValidDimension(this)
